...
export function ClientShell({ title, children }: ClientShellProps) {
  ...
  return (
    <div className='min-h-screen bg-bg-base flex flex-col'>
      <header className='sticky top-0 z-30 bg-bg-surface border-b border-border-main'>
        <div className='h-14 flex items-center justify-between gap-3 px-4 max-w-2xl mx-auto w-full'>
      ...
      <main className='flex-1 px-4 py-4 pb-24 lg:pb-6 max-w-2xl mx-auto w-full animate-page-in'>
        {children}
      </main>
